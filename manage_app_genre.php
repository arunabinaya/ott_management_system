...
if (!isset($_GET['keyword'])) {
    $sql_query = "SELECT * FROM tbl_genre ORDER BY id ASC"; 
} else {
    $keyword = addslashes(trim($_GET['keyword']));
    $sql_query = "SELECT * FROM tbl_genre WHERE language_name LIKE '%$keyword%' ORDER BY id DESC"; 
}
        ...
        <div class="card h-100">
            <div class="card-top d-md-inline-flex align-items-center justify-content-between py-3 px-4">
                ...
                <div class="d-flex mt-2 mt-md-0">
                    ...
                    <a href="create_app_genre.php?add=yes" class="btn btn-primary d-inline-flex align-items-center justify-content-center">
                        <i class="ri-add-line"></i>
                        <span class="ps-1 text-nowrap d-none d-sm-block">Create App Genre</span>
                    </a>
                </div>
            </div>
                            ...
                            <tbody>
                                <?php $i = 1; while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="create_app_genre.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
