                    ...
                    <div class="nsofts-setting__content">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="nsofts_setting_content_3" role="tabpanel" aria-labelledby="nsofts_setting_3" tabindex="0">
                                <form action="" method="post" id="submit_code">
                                    ...
                                    <button type="submit" name="submit_code" class="btn btn-primary" style="min-width: 120px;">Save</button>
                                </form>
                            </div>
                            
                            <div class="tab-pane fade" id="nsofts_setting_content_4" role="tabpanel" aria-labelledby="nsofts_setting_4" tabindex="0">
                                <form action="" method="post" id="submit_rtl">
                                    <h4 class="mb-4">Admin Panel Setting</h4>
                                    <div class="mb-3 row">
                                        <label for="" class="col-sm-2 col-form-label">RTL</label>
                                        <div class="col-sm-10">
                                            <div class="nsofts-switch d-flex align-items-center">
                                                <input type="checkbox" id="site_direction" name="site_direction" value="1" class="nsofts-switch__label" <?php if($settings_data['site_direction']=='1'){ echo 'checked'; }?>/>
